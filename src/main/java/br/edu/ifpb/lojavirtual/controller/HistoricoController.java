...
public class HistoricoController {
    ...
    private Node criarCardPedido(Pedido pedido) {
        ...
        String corStatus = switch (pedido.getStatus()) {
            case PAGO -> "#2196F3";
            case ENVIADO -> "#FF9800";
            case ENTREGUE -> "#00A60E";
            case CANCELADO -> "#F44336";
            default -> "#757575";
        };
        statusLabel.setStyle("-fx-background-color: " + corStatus + "; -fx-text-fill: white; " + "-fx-padding: 3 12; -fx-background-radius: 15; -fx-font-weight: bold; -fx-font-size: 11px;");
